...
int main(int argc, string argv[])
{
    ...
    // printf(" a ver s y es candidate.votes[2] %i\n y el array_votos[2] %i\n ",  candidates[2].votes,  array_votos[2]);
...
print_winner();
    ...
    for (int i = 0; i < candidate_count; i++)
    {
        ...
        if (candidates[i].votes == maximos_votos)
...
{
    // TODO
    // int maximos_votos = mayor_voto(candidate_count, array_votos); //damos el numero de candidatos que es la longitud del array y lal lista de suma de votos
