...
// no repetir nombres de variables en la funciones externas desde esta funcion
    ...
    if (resto25 == 0)
    {
        printf("Monedas totales de 25: %i y mopndeas totales (en este caso coincide)  %i \n", monedas25 , monedas25);
    ...
    else
    {
        ...
        if (resto10 == 0)
        {
            printf("Monedas totales de 25: %i, Monedas totales de 10: %i,  y mopndeas totales:  %i \n", monedas25 , monedas10, monedas25 + monedas10);
        ...
        if (resto5 == 0)
        {
            printf("Monedas totales de 25: %i, Monedas totales de 10: %i,  y mopndeas totales 5:  %i y mopndeas totales:  %i \n", monedas25 , monedas10, monedas5, monedas25 + monedas10 + monedas5);
        ...
        else
        {
            ...
            if (resto1 == 0)
            {
                printf("Monedas totales de 25: %i, Monedas totales de 10: %i,  y mopndeas totales 5:  %i, y mopndeas totales 1:  %i y mopndeas totales:  %i \n", monedas25 , monedas10, monedas5, monedas1, monedas25 + monedas10 + monedas5 + monedas1);
...
float cambio(void)
{
    ...
    do
    {
        cantidad_cambio = get_float("escribe una cantidad de cambio positiva: ");
    }
